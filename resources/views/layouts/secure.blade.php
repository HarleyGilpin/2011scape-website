            ...
            <ul id="menus">
                ...
                <li class="top"><a id="play" class="tl" href="/game.html"><span class="ts">Play Now</span></a>
                    <ul>
                        ...
                        <li><a href="/game.html" id="playExisting" class="fly"><span>Existing Users</span></a></li>
                ...
                <li class="top"><a id="account" class="tl" href="/account_management.html"><span class="ts">Account</span></a>
                    <ul>
                        ...
                        <li><a href="/services/m=forum/register/" id="menuPlay2" class="fly"><span>Create New Account</span></a></li>
                ...
                @auth
                    <li class="top">
                        <form method="post" action="/secure/m=weblogin/logout.html" style="display:inline;margin:0;padding:0">
                            @csrf
        ...
        <div id="scroll">
            <div id="head">
                <div id="headBg">
                    <div id="langAndLogin">
                        <div id="lang">
                            <a href="#"><img alt="English" title="English" src="/img/main/layout/en.gif"></a>
                        </div>
                    </div>
                    <div class="navigation">
                        <div class="location"><b>Location: </b> <a href="/">Home</a> &gt; @yield('crumb', 'Secure')</div>
                    </div>
                </div>
            </div>
            <div id="content">
