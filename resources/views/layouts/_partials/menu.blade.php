<ul id="menus">
    ...
    <li class="top"><a id="play" class="tl" href="/play"><span class="ts">Play Now</span></a>
        <ul>
            <li><a href="/play" id="menuPlay1" class="fly"><span>New Users</span></a></li>
            <li><a href="/play" id="playExisting" class="fly"><span>Existing Users</span></a></li>
    ...
    @auth
        <li class="top">
            <form method="post" action="/logout" style="display:inline;margin:0;padding:0">
                @csrf
                <button type="submit" id="login" class="tl" style="background:none;border:0;cursor:pointer;color:inherit;font:inherit"><span class="ts">Log Out ({{ Auth::user()->displayName() }})</span></button>
            </form>
        </li>
    @else
