...
@section('title', 'Splash Media 1 - 2011scape')
@section('crumb', 'Splash Media 1')
...
@section('content')
     ...
     <div id="media"> 
      <div id="stickout"></div> 
      <div id="trailerMedia" class="mediaItem mediaItemActive"> <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"> <param name="movie" value="img/main/splash2010/frame.swf.html"> <param name="FlashVars" value="trailerPath=img/main/splash2010/&amp;trailerType=runescape_.html"> <param name="wmode" value="opaque"> <!--[if !IE]>--> <object type="application/x-shockwave-flash" data="img/main/splash2010/frame.swf.html"> <param name="FlashVars" value="trailerPath=img/main/splash2010/&amp;trailerType=runescape_.html"> <param name="wmode" value="opaque"> <!--<![endif]--> <p>Sorry you need <a href="http://www.macromedia.com/go/getflashplayer" target="_blank">Flash Player</a> to view this trailer.</p> <!--[if !IE]>--> </object> <!--[if !IE]>--><!--<![endif]--> </object> 
      </div><!--.mediaItem[.mediaItemActive]--> 
      <div id="screenMedia" class="mediaItem"> <a id="previous" class="screenControl" href="splash-media-2-amp;screen-8.html"><span>Previous screenshot...</span></a> <a id="next" class="screenControl" href="splash-media-2-amp;screen-1.html"><span>Next screenshot...</span></a> 
       <img id="screenImage" class="mediaHolder" src="img/main/splash2010/screen/1.jpg" alt=""> 
      </div> 
     </div> 
     <div id="buttons"> <a id="trailer" class="mediaButton mediaButtonLeft HoverImg HoverImgActive" href="splash-media-1.html"><img src="img/main/splash2010/buttons.jpg" alt="Watch Trailer" title=""></a> <a id="screen" class="mediaButton mediaButtonRight HoverImg" href="splash-media-2.html"><img src="img/main/splash2010/buttons.jpg" alt="View Screenshots" title=""></a> 
     </div> 
